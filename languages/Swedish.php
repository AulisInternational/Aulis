...
|| Version:				1.0.0
|| Dialect:				Standard Swedish (rikssvenska)
...
define('LANGUAGE_NAME', 'svenska');
define('LANGUAGE_CODE', 'sv');

// Strings that are used pretty much everywhere
define('FOOTER_LANGUAGE', 'Språk: ');

// These strings are used for dates
define('DATE_TODAY', 'I dag');
define('DATE_YESTERDAY', 'I går');
