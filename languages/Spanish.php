...
define('REGISTER_USERNAME', 'Usuario:');
...
define('REGISTER_PASSWORD2', 'Confirmar contraseña:');
...
define('REGISTER_BIRTHDATE', 'Fecha de nacimiento:');
...
define('REGISTER_SUBMIT', 'Regístrate');
...
define('REGISTER_CONFIRM_AGE', 'Por favor confirma tu edad.');
