...
INSERT INTO `aulis_blog_categories` (`id`, `category_name`, `category_order`) VALUES
(1, 'General entries',  0),
(2, 'Music',  1),
(3, 'Countries',  -2),
(4, 'Song lyrics',  0),
...
INSERT INTO `aulis_blog_comments` (`id`, `blog_id`, `logged`, `user_id`, `user_name`, `content`, `post_date`) VALUES
